...
public class Utility {
    public static final String JSON_RESULT_TAG = "results";
    public static final String MOVIE_ID_TAG = "id";
    public static final String MOVIE_TITLE_TAG = "original_title";
    public static final String MOVIE_POSTER_TAG = "poster_path";
    public static final String MOVIE_BACKGROUND_TAG = "backdrop_path";
    public static final String MOVIE_OVERVIEW_TAG = "overview";
    public static final String MOVIE_VOTE_AVERAGE_TAG = "vote_average";
    public static final String MOVIE_RELEASE_DATE_TAG = "release_date";
